...
bool VerificarPalabra(vector<int> w, int T[MAX][MAX], int q0, vector<int>qf,vector<int>Estados){
...
//		w.clear();
            ...
            case 2:
                ...
                if(AutomataIngresado){
                    ...
                    EstadoVerificacion = VerificarPalabra(w, Transiciones, q0, qf,Estados);
